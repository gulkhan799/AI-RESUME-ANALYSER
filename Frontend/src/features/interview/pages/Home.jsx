...
const Home = () => {
    ...
    {/* Logout Button — moved OUTSIDE header */}
    <button onClick={handleSignOut} className='logout-btn' type="button">
                        ...
                        <div className='upload-section'>
                            ...
                            {uploadedFileName ? (
                                <div className='dropzone dropzone--success'>
                                    <span className='dropzone__success-icon' aria-hidden="true">
                                    ...
                                    <p className='dropzone__filename' title={uploadedFileName}>{uploadedFileName}</p>
                                    <button type="button" className='dropzone__change-btn' onClick={handleClearResume}>
